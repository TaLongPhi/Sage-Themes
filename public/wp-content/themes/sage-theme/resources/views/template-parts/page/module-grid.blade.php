    ...
    <div class="cus-container flex flex-col items-center justify-center mx-auto max-w-552 w-4/5 xl:w-3/5">
        ...
        <div class="xl:flex items-start min-h-240 text-center">
            <div class="info-col self max-w-288">
                <div>
                    <img class="info-icon w-full h-40 " src="{!! App::getIcon()['icon1'] !!}" alt="{!! App::getIcon()['alt'] !!}">
                </div>
            ...
            <div class="rotate">
                <img class="w-175 xl:my-25 md:my-83 md:mx-auto" src="{!! App::getIcon()['icon2'] !!}"
                    alt="{!! App::getIcon()['alt'] !!}">
            </div>
            <div class="info-col self max-w-288">
                <div>
                    <img class="info-icon w-full h-40" src="{!! App::getIcon()['icon3'] !!}" alt="{!! App::getIcon()['alt'] !!}">
                </div>
            ...
            <div class="info-col self max-w-288">
                <div>
                    <img class="info-icon w-full h-40" src="{!! App::getIcon()['icon4'] !!}" alt="{!! App::getIcon()['alt'] !!}">
                </div>
