<section class="w-full wrap mt-50 mb-80">
    <div class="xl:w-5/6 xl:flex md:w-full">
        <div class="xl:w-1/2 md:w-full relative bg-slate-100 2xl:h-392">
            <img src="<?php echo App::getBanner()['Business']; ?>" alt="<?php echo App::getBanner()['alt1']; ?>" 
            class="3xl:w-11/12 2xl:w-full h-500 xl:absolute xl:ml-75 shadow-blue-200 mx-auto ">
        </div>
        <div class="xl:w-1/2 md:w-4/5 mod_padding xl:mt-0 md:mt-70 md:mx-auto">
            ...
            <button class="w-102 h-27 btn-brown text-base font-bold mt-16 rounded-4xl">LEARN MORE</button>
        </div>
    </div>
</section>